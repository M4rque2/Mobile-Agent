...
class AdbTools:
    ...
    def get_screenshot(self, image_path, retry_times=3):
        ...
        """
        # Wake the screen so screenshots are not black when device is idle
    ...
    def type(self, text):
        ...
        Falls back to Android clipboard paste when ADB Keyboard is unavailable.
        """
    ...
    def _adb_input_text_safe(self, text):
        """Best-effort text for adb shell input text, which is ASCII-oriented."""
    ...
    def _type_with_adb_keyboard(self, text):
        """Input text through ADBKeyboard.apk if the IME is installed."""
    ...
    def _type_with_clipboard(self, text):
        """Set Android clipboard and paste into the focused field."""
...
def image_to_base64(image_path):
    ...
    MIN_PIXELS = 3136
    MAX_PIXELS = 1003520  # ~1286 tokens per image (Qwen-VL standard resolution)
